...
void cal(card a[], int n, char b1[], char b2[])
{
    ...
    for (int i = 1; i <= n; i++)
    {
        if (a[i].facevalues == 11 || a[i].facevalues == 12)
        {
            allscore = allscore + 10;
        }
        else
        {
            allscore = allscore + a[i].facevalues;
        }
    }
    printf("%d", allscore);
}
int main()
{
    ...
    for (int i = 1; i <= n; i++)
    {
        ...
        if (arrayt1[i] == 'A')
        {
            array[i].facevalues = 1;
        }
        else if (arrayt1[i] == '2')
        {
            array[i].facevalues = 2;
        }
        else if (arrayt1[i] == '3')
        {
            array[i].facevalues = 3;
        }
        else if (arrayt1[i] == '4')
        {
            array[i].facevalues = 4;
        }
        else if (arrayt1[i] == '5')
        {
            array[i].facevalues = 5;
        }
        else if (arrayt1[i] == '6')
        {
            array[i].facevalues = 6;
        }
        else if (arrayt1[i] == '7')
        {
            array[i].facevalues = 7;
        }
        else if (arrayt1[i] == '8')
        {
            array[i].facevalues = 8;
        }
        else if (arrayt1[i] == '9')
        {
            array[i].facevalues = 9;
        }
        else if (arrayt1[i] == 'J')
        {
            array[i].facevalues = 10;
        }
        else if (arrayt1[i] == 'Q')
        {
            array[i].facevalues = 11;
        }
        else if (arrayt1[i] == 'K')
        {
            array[i].facevalues = 12;
        }
        else
        {
            array[i].facevalues = 0;
        }
        if (arrayt2[i] == 'C')
        {
            array[i].suits = 1;
